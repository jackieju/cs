...
/***** old code ********
			...
			if (NeedCast(dt1, dt2, casted) <=0)
				...
				else
				{
					...
					if (casted == 1)
					{			
						address_mode = 	getAddressMode(AMODE_MEM, type1, dt2, dt1);
					...
					if (casted == 2)
					{
						address_mode = 	getAddressMode(AMODE_MEM, type2, dt1, dt2);
...
{
	//get address mode
	int address_mode = getAddressMode(type1, type2, dt1, dt2);
/*
